...
public class AppRun {
    ...
    public static void main(String[] args) {
        ...
        executor.execute(() -> StudiKasus1.digitFaktorial());
        executor.execute(() -> StudiKasus1.cekKeberadaanPrima(10000, 9873));
        executor.execute(() -> StudiKasus1.hitungKuadrat(15458));
        executor.execute(() -> StudiKasus1.cariMaksimum());
        executor.execute(() -> StudiKasus1.jumlahkanArray());
